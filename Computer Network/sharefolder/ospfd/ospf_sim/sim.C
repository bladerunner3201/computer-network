...
int ToggleRouter(ClientData, Tcl_Interp *, int, const char *argv[]);
int StartPing(ClientData, Tcl_Interp *, int, const char *argv[]);
int StopPing(ClientData, Tcl_Interp *, int, const char *argv[]);
int StartTraceroute(ClientData, Tcl_Interp *, int, const char *argv[]);
int StartMtrace(ClientData, Tcl_Interp *, int, const char *argv[]);
...
int SendGroup(ClientData, Tcl_Interp *, int, const char *argv[]);
int LeaveGroup(ClientData, Tcl_Interp *, int, const char *argv[]);
