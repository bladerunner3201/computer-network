...
/* Routines covering both the Linux ospfd routing daemon
...
void Linux::monitor_response(struct MonMsg *msg, uns16 code, int len, int fd)
...
/* Constructor for the common Linux OspfSysCalls
 * class.
 */

Linux::Linux(uns16 mon_port) : OspfSysCalls()
...
void Linux::mon_fd_set(int &n_fd, fd_set *fdsetp, fd_set *wrsetp)
...
void Linux::process_monitor_request(TcpConn *conn)
...
void Linux::accept_monitor_connection()
...
void Linux::close_monitor_connection(TcpConn *conn)
